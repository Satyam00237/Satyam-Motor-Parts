                                    ...
                                    <div key={item._id} className="cart-item">
                                        <div className="cart-item-info">
                                            <div className="cart-item-img">
                                                {item.image ? <img src={item.image.startsWith('/') ? `${process.env.REACT_APP_API_URL?.replace('/api', '') || 'https://satyam-motor-parts.vercel.app'}${item.image}` : item.image} alt={item.name} /> : '⚙️'}
                                            </div>
                                            <div>
